...
public class MyGenerator {
    ...
    private static String outputDir = "D:\\idea_workplace\\generator\\mybatis-plus-generator\\src\\main\\java";
    private static String parent = "com.skkj.tpm.config";
...
//            )
            ...
            .injectionConfig(builder -> builder
                .beforeOutputFile((tableInfo, stringObjectMap) ->
                    ...
                    stringObjectMap.put("pkColumn",e.getPropertyName());
                    stringObjectMap.put("pkType",e.getPropertyType());
                })) //输出前操作，这里添加了模板上下文信息
...
//                .superClass(BaseEntity.class)   //设置父类
                ...
                .addSuperEntityColumns("searchValue", "create_by", "create_time",
                    "update_by", "update_time","remark","order_num")  //父类公共字段
                /* controller 策略配置 */
                .controllerBuilder()
                .enableFileOverride()
